                    ...
                    <div class="viewer_action_btn">
                        ...
                        <router-link class="p_btn" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-title="Edit"
                            ...
                            " :to="{
                                ...
                                params: { id: parentId || $parent.data.id },
                                query: {
                        ...
                        <button type="button" class="p_btn" data-bs-toggle="tooltip" data-bs-placement="top"
                            ...
                            " @click="
                                destroy($parent.data.id, $parent.data.is_delete ?? null)
...
export default {
    ...
    methods: {
        destroy(id, is_delete) {
            this.deleted_id = id;
            console.log('deleted', this.is_delete);
        ...
        deleteConfirm() {
            ...
            axios
                ...
                .then((res) => {
                    if (res.data) {
                        if (this.xDeleteViewData) {
                            this.xDeleteViewData();
                        } else {
