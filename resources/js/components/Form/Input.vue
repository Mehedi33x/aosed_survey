        ...
        <div class="form-group">
            ...
            <div class="input-group position-relative">
                ...
                <input :type="type" @input="updateModel($event)" @blur="updateModel($event)" :value="modelValue"
                    ...
                    :field="field" />
                <!-- <button type="button" class="reset_input_value position-absolute bg-transparent top-50 translate-middle-y border-0" data-bs-toggle="tooltip"
                    data-bs-placement="top" data-bs-title="Reset" v-x-tooltip>
                ...
                <!-- use this slot to append extra content -->
