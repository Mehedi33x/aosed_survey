    ...
    <div :class="`col-md-${col}`">
        <div class="form-group">
            ...
            <div class="input-group position-relative">
                ...
                <textarea :id="id ?? `input-${uuid}`" @input="updateModel($event)" @blur="updateModel($event)"
                    :value="modelValue" class="form-control" :class="{ error: has_error }" :placeholder="title"
                    :disabled="disabled" :readonly="readonly" :name="fieldName" :rows="rows"></textarea>
            </div>
        </div>
    </div>
</template>
