    ...
    <create-form @onSubmit="submit">
        <div class="row align-items-center">
                ...
                <template v-slot:content>
                    <div class="row">
                        <div class="col-xl-2 col-lg-3">
                            <File title="Logo" field="data.logo" mime="img" :req="true" fileClassName="file1"
                                :showCrop="true" vHeight="200" vWidth="200" vSizeInKb="300" :deleteButton="false" />
                        </div>

                        <div class="col-xl-2 col-lg-3">
                            <File title="Logo Small" field="data.logo_small" mime="img" fileClassName="file2"
                                :req="true" vHeight="200" vWidth="200" vSizeInKb="300" :deleteButton="false" />
                        </div>

                        <div class="col-xl-2 col-lg-3">
                            <File title="Favicon Logo" field="data.favicon" mime="img" fileClassName="file3"
                                vHeight="200" vWidth="200" vSizeInKb="300" :deleteButton="false" />
                        </div>
                    </div>

                    <GlobalCrop field="data.logo" v-on:update:modelValue="data.logo = $event" :image="image.logo"
                        :aspectRatio="{ aspectRatio: 200 / 200 }" :minWidth="200" :minHeight="200"></GlobalCrop>
                </template>
            </Fieldset>
            ...
            <Fieldset>
                ...
                <template v-slot:content>
                    <Input title="Title" field="data.title" v-model="data.title" :req="true" col="6" />

                    <Input title="Short Title" field="data.short_title" v-model="data.short_title" :req="true"
                        col="6" />

                    <Input title="Contact Email (Optional)" field="data.contact_email" v-model="data.contact_email"
                        type="email" :req="false" />

                    <Input title="Feedback Email (Optional)" field="data.feedback_email" v-model="data.feedback_email"
                        type="email" :req="false" />

                    <Input title="Mobile One (Optional)" field="data.mobile1" v-model="data.mobile1" type="text"
                        :req="false" />

                    <Input title="Mobile Two (Optional)" field="data.mobile2" v-model="data.mobile2" type="text"
                        :req="false" />
                </template>
            </Fieldset>
      ...
      /> -->
            ...
            <Fieldset>
                ...
                <template v-slot:content>
                    <Textarea title="Address (Optional)" field="data.address" v-model="data.address" :req="false"
                        col="12" />

                    <Textarea title="Map Link (Optional)" field="data.map" v-model="data.map" :req="false" col="12" />
                </template>
            </Fieldset>
            ...
            <Fieldset>
                ...
                <template v-slot:content>
                    <Input title="Web (Optional)" field="data.web" v-model="data.web" type="url" :req="false" col="6"
                        placeholder="https://abcd.xyz" />

                    <Input title="Facebook (Optional)" field="data.fb" v-model="data.fb" type="url" :req="false" col="6"
                        placeholder="https://facebook.com" />

                    <Input title="Twitter (Optional)" field="data.tw" v-model="data.tw" type="url" :req="false" col="6"
                        placeholder="https://twitter.com" />

                    <Input title="Linkedin (Optional)" field="data.ln" v-model="data.ln" type="url" :req="false" col="6"
                        placeholder="https://linkedin.com" />

                    <Input title="Youtube (Optional)" field="data.yt" v-model="data.yt" type="url" :req="false" col="6"
            ...
            <Fieldset>
                ...
                <template v-slot:content>
                    <ColorPicker title="Navbar (Optional)" field="data.navbar_color" v-model="data.navbar_color"
                        col="2 col-sm-4 col-md-3" />

                    <ColorPicker title="Breadcrumb (Optional)" field="data.breadcrumb_color"
                        v-model="data.breadcrumb_color" col="2 col-sm-4 col-md-3" />

                    <ColorPicker title="Sidebar (Optional)" field="data.sidebar_color" v-model="data.sidebar_color"
                        col="2 col-sm-4 col-md-3" />

                    <ColorPicker title="Sidebar Footer (Optional)" field="data.sidebar_footer_color"
                        v-model="data.sidebar_footer_color" col="2 col-sm-4 col-md-3" />

                    <ColorPicker title="Sidebar Top (Optional)" field="data.sidebar_top_color"
                        v-model="data.sidebar_top_color" col="2 col-sm-4 col-md-3" />
                </template>
            </Fieldset>
        </div>
