    ...
    <index-page :show_status="false">
        <template v-slot:search-field>
            ...
            <Select title="Select Indicator" v-model="search_data.indicator_id" field="search_data.indicator_id"
                ...
                :closeOnSelect="true" :required="false" col="4"
                @update:modelValue="getActivityByIndicator(search_data.indicator_id)" />
            ...
            <Select title="Select Group" v-model="search_data.group_id" field="search_data.group_id" label="title"
...
const tableColumns = [
    ...
    { field: "execute_by", title: "Executed By", subfield: "admin.name" },
    { field: "total_beneficiary", title: "Total Beneficiary", align: "center" },
    { field: "execute_date", title: "Executed Date", align: "center" },
