<template>
    <div class="content-part">
        <div class="inner-content">
            <slot name="button">
                <AddOrBackButton :route="model + '.index'" :portion="model" :icon="'fas fa-backward'" />
            </slot>
                        ...
                        <div class="profile-main">
                            <div class="profile-image">
                                <div class="img position-relative">
                                    ...
                                    <img v-else
                                        :src="data.profile ? data.profile : `${$root.baseurl}/images/profile.png`"
                            ...
                            <GlobalCrop field="data.profile" v-on:update:modelValue="data.profile = $event"
                                :image="image.profile" :aspectRatio="{ aspectRatio: 200 / 200 }" :minWidth="200"
                                :minHeight="200"></GlobalCrop>
                            ...
                            <nav>
                                <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                    <button class="nav-link active" id="nav-home-tab" data-bs-toggle="tab"
                                        ...
                                        aria-selected="false" @click="passwordOption(false)">
                                        Information
                                    </button>

                                    <button class="nav-link" id="nav-profile-tab" data-bs-toggle="tab"
                                        data-bs-target="#nav-profile" type="button" role="tab"
                                        aria-controls="nav-profile" aria-selected="true" @click="passwordOption(true)">
                                        Change Password
                                    </button>
                                </div>
                            </nav>
                            <div class="tab-content" id="nav-tabContent">
                                <div class="tab-pane fade active show" id="nav-home" role="tabpanel"
                                    ...
                                    <div class="update-profile-info show">
                                        <form @submit.prevent="updateInformation" id="updateInfoForm">
                                            <div class="row">
                                                <Input v-model="data.name" field="data.name" title="Name" col="4"
                                                    :req="true" />
                                                <Input v-model="data.mobile" field="data.mobile" title="Mobile" col="4"
                                                    :req="true" />
                                                <Input v-model="data.email" field="data.email" title="Email" col="4"
                                                    :req="true" disabled />
                                            </div>
                                    ...
                                    <div class="update-profile-info">
                                        <form @submit.prevent="changePassword">
                                            <div class="row align-items-center">
                                                <Input v-model="change_pass.old_password"
                                                    field="change_pass.old_password" title="Old password" col="6"
                                                    :req="true" />
                                                <div class="row">
                                                    <Input v-model="change_pass.confirm_password"
                                                        field="change_pass.confirm_password" title="New password"
                                                        col="6" :req="true" />

                                                    <Input v-model="change_pass.new_password"
                                                        field="change_pass.new_password" title="Confirm password"
                                                        col="6" :req="true" />
                                                </div>
                                            </div>
                                            <Button title="Update" process="" />
