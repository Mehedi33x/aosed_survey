                                ...
                                <Fieldset>
                                    ...
                                    <template v-slot:content>
                                        ...
                                        <Input v-model="data.mobile_no" field="data.mobile_no" title="Mobile No"
                                            :req="true" col="3" />
                                        <Input v-model="data.emergencey_contact" field="data.emergencey_contact" title="Emergency Contact"
                                            :req="true" col="3" />
                                        <Input v-model="data.email" field="data.email" title="Email" :req="false"
                                            col="3" />
                                        <div class="col-lg-3">
                                            <Radio title="Select Gender" v-model="data.gender" field="data.gender"
                                                :list="global.gender" col="12" :showResetButton="true" />
                                        </div>
                                        <div class="col-3">
                                            <Radio title="Select Marital Status" v-model="data.marital_status"
                                                field="data.marital_status" :list="global.maritalStatus" :req="true"
                                                col="12" :showResetButton="true" />
                                        </div>
                                            ...
                                            :image="image.original_image" :aspectRatio="{
                                                aspectRatio:
                                                    ($root.media_validators?.profile?.min_width ??
                                                        600) /
                                                    ($root.media_validators?.profile?.mien_height ??
                                                        600),
                                        ...
                                        <File title="National ID" field="data.nid_card" mime=".pdf"
                                            fileClassName="data.nid_card" :req="false" col="3" vSizeInKb="10240"
                                            vType="pdf" />

                                        <div class="form-group">
                                            <div class="input-group position-relative">
                                                <Textarea title="Remarks" field="data.remarks" v-model="data.remarks"
                                                    :req="false" col="12" />
                                            </div>
                                        </div>
                                    </template>
                                ...
                                <Fieldset>
                                    ...
                                    <template v-slot:content>
                                        ...
                                        <Select title="Present Upazila" field="data.pre_upazilla_id" :req="true"
                                            ...
                                            col="3"
                                            @update:modelValue="getThanaByUpazila('pre', data.pre_upazilla_id)" />
                                        <Select title="Present Thana" field="data.pre_thana_id" :req="true"
                                            v-model="data.pre_thana_id" label="name" :reduce="(obj) => obj.id"
                                            :options="preThanas" placeholder="--Select One--" :closeOnSelect="true"
                                            col="3" />
                                        <div class="col-md-3">
                                ...
                                <Fieldset>
                                    ...
                                    <template v-slot:content>
                                        ...
                                        <Select title="Permanent District" field="data.per_district_id" :req="true"
                                            ...
                                            col="3"
                                            @update:modelValue="getperUpazilaByDistrict(data.per_district_id)" />
                                        <Select title="Permanent Upazila" field="data.per_upazilla_id" :req="true"
                                            ...
                                            col="3"
                                            @update:modelValue="getThanaByUpazila('per', data.per_upazilla_id)" />
                                        <Select title="Permanent Thana" field="data.per_thana_id" :req="true"
                                            v-model="data.per_thana_id" label="name" :reduce="(obj) => obj.id"
                                            :options="perThanas" placeholder="--Select One--" :closeOnSelect="true"
                                            col="3" />
                                    </template>
                                </Fieldset>
                            </div>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="isFieldRequired(educationIndex)">
                                                        Exam is required when Board, Institute, or Result is filled.
                                                    </small>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="education.boardError">
                                                        Board is required when Exam is selected.
                                                    </small>
                                                </td>
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="education.instituteError">
                                                        Institute is required when Exam is selected.
                                                    </small>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="education.resultError">
                                                        Result is required when Exam is selected.
                                                    </small>
                                    ...
                                    <table class="table table-bordered mb-0 mt-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th style="min-width: 200px">Occupation Title</th>
                                                <th style="min-width: 40px">Is Primary</th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <Select
                                                        ...
                                                        placeholder="--Select One--" :closeOnSelect="true" col="12" />
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="ocupationsFieldRequired(ocupationIndex)">
                                                        Occuption is required
                                                    </small>
                                                </td>
                                                <td>
                                                    <div class="form-check my-3">
                                                        <input class="form-check-input" type="checkbox"
                                                            v-model="ocupation.is_primary"
                                                            @change="handlePrimarySelection(ocupationIndex)"
                                                            :id="`is_primary_${ocupationIndex}`"
                                                            field="beneficiary_occupations[ocupationIndex].is_primary"
                                                            :true-value="1" :false-value="0" />
                                                        <label class="form-check-label"
                                                            :for="`is_primary_${ocupationIndex}`">
                                                            Primary
                                                        </label>
                                                    </div>
                                                    <!-- <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="ocupation.isPrimaryError">
                                                        Please select if this is the primary occupation.
                                                    </small> -->
                                                </td>
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="ocupation.workinghourError">
                                                        Working Hour is required when Occupation is selected.
                                                    </small>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="ocupation.worklocationError">
                                                        Work Location is required when Occupation is selected.
                                                    </small>
                                                </td>
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="ocupation.monthlyincomeError">
                                                        Work Location is required when Occupation is selected.
                                                    </small>
                                                </td>
                                                <td>
                                        ...
                                        <template v-slot:content>
                                            <div class="col-lg-3">
                                                <Select title="Relation"
                                                    field="beneficiary_family_members[familyIndex].relation_id"
                                                    :req="true" v-model="beneficiary_family_member.relation_id"
                                                    label="title" :reduce="(obj) => obj.id" :options="allRelations"
                                                    placeholder="--Select One--" :closeOnSelect="true" col="12" />
                                                <small class="text-danger d-inline-block fw-medium mt-1"
                                                    v-if="familyFieldRequired(familyIndex)">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <small class="text-danger d-inline-block fw-medium mt-1"
                                                    v-if="beneficiary_family_member.nameError">
                                                    Name is required when relation is selected.
                                                </small>
                                            </div>
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <small class="text-danger d-inline-block fw-medium mt-1"
                                                    v-if="beneficiary_family_member.genderError">
                                                    Gender is required when Relation is selected.
                                                </small>
                                            </div>
                                            ...
                                            <Select title="Going to School"
                                                ...
                                                :req="familyFieldRequired(familyIndex)"
                                                v-model="beneficiary_family_member.goes_to_school" :options="[
                                                    { id: 0, name: 'Yes' },
                                                    { id: 1, name: 'No' }
                                            ...
                                            <div class="col-3">
                                                ...
                                                <small class="text-danger d-inline-block fw-medium mt-1"
                                                    v-if="beneficiary_family_member.maritalstatusError">
                                                    marital status is required when Relation is selected.
                                                </small>
                                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-12">
                                <Fieldset>
                                    ...
                                    <template v-slot:content>
                                        <Input title="Height" v-model="data.beneficiary_healths.height"
                                            field="data.beneficiary_healths.height" :req="false" col="3 col-lg-3" />
                                        <Input title="Weight" v-model="data.beneficiary_healths.weight"
                                            field="data.beneficiary_healths.weight" :req="false" col="3 col-lg-3" />

                                        <Select title="Physical Condition"
                                            field="data.beneficiary_healths.physical_condition" :req="false"
                                            v-model="data.beneficiary_healths.physical_condition" label="name"
                                            :reduce="(obj) => obj.value" :options="global.physicalCondition" placeholder="--Select One--"
                                            :closeOnSelect="true" col="3 col-lg-3" />
                                                ...
                                                <tbody
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <small class="text-danger d-inline-block fw-medium mt-1"
                                                                v-if="diseaseFieldRequired(diseaseIndex)">
                                                        ...
                                                        <td>
                                                            <date-picker :id="`affected_date_${diseaseIndex}`"
                                                                ...
                                                                label="From Date"></date-picker>
                                                            <small class="text-danger d-inline-block fw-medium mt-1"
                                                                v-if="beneficiary_disease.affectdateError">
                                                                Affected is required when Disease is selected.
                                                            </small>
                                                        </td>
                                                        <td>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <Select field="beneficiary_wealths[wealthIndex].wealth_id"
                                                        ...
                                                        placeholder="--Select One--" :closeOnSelect="true" col="12" />
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="wealthFieldRequired(wealthIndex)">
                                                        Wealth is required
                                                    </small>
                                                </td>
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="beneficiary_wealth.sourceofownershipError">
                                                        Source Of wonership is required when Wealth is selected.
                                                    </small>
                                                </td>
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="beneficiary_wealth.quantityError">
                                                        Quantity is required when Wealth is selected.
                                                    </small>
                                                </td>
                                                <td>
                                                    <div class="col-md-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <Select field="benificiary_assets[assetIndex].asset_id" :req="false"
                                                        ...
                                                        placeholder="--Select One--" :closeOnSelect="true" col="12" />
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="assetFieldRequired(assetIndex)">
                                                        Asset is required
                                                    </small>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="benificiary_asset.sourceofownershipError">
                                                        Source Of wonership is required when Asset is selected.
                                                    </small>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="benificiary_asset.quantityError">
                                                        Quantity is required when Asset is selected.
                                                    </small>
                                                </td>
                                                <td>
                                                    <div class="col-md-12">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <Select field="beneficiary_liabilites[liabilityIndex].liability_id"
                                                        ...
                                                        :closeOnSelect="true" col="12" />
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="liabilitesFieldRequired(liabilityIndex)">
                                                ...
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="beneficiary_liabilite.loanfromError">
                                                        Loan From is required when Liability is selected.
                                                    </small>
                                                </td>
                                                <td>
                                                    ...
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="beneficiary_liabilite.amountError">
                                                        Amount required when Liability is selected.
                                                    </small>
                                                </td>
                                                ...
                                                <td>
                                                    <date-picker :id="`start_date_${liabilityIndex}`"
                                                        ...
                                                        label="From Date"></date-picker>
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="beneficiary_liabilite.startdateError">
                                                        Start Date is required when Liability is selected.
                                                    </small>
                                                </td>
                                                <td>
                                                    <date-picker :id="`end_date_${liabilityIndex}`"
                                                        ...
                                                        label="From Date"></date-picker>
                                                    <small class="text-danger d-inline-block fw-medium mt-1"
                                                        v-if="beneficiary_liabilite.enddateError">
                                                        End Date is required when Liability is selected.
                                                    </small>
                                                </td>
                                                <td>
                                                    <div
...
export default {
    computed: {
        ...
        healths() {
            const healths = [];
            if (this.physicalCondition && Object.keys(this.physicalCondition).length > 0) {
                this.physicalCondition.forEach(function (type) {
                    healths.push({
                        name: type.name,
                        value: type.value,
    ...
    data() {
        return {
            ...
            data: {
                ...
                //Auto present address change to permanent address
                present_address: '',
                permanent_address: '',
                pre_state_id: null,
                per_state_id: null,
                pre_district_id: null,
                per_district_id: null,
                pre_upazilla_id: null,
                per_upazilla_id: null,
                //End present address change to permanent address
                block: false,
                image: "",
                date_of_birth: "",
                birth_certificate: "",
    ...
    watch: {
        // Watch for changes in Present Address
        'data.present_address'(newValue) {
            if (this.data.block) {
                this.data.permanent_address = newValue;
            }
        },
        // Watch for changes in Permanent Address
        'data.permanent_address'(newValue) {
            if (this.data.block) {
                this.data.present_address = newValue;
            }
        },
        // Watch for changes in Present State
        'data.pre_state_id'(newValue) {
            if (this.data.block) {
                this.data.per_state_id = newValue;
            }
        },
        // Watch for changes in Permanent State
        'data.per_state_id'(newValue) {
            if (this.data.block) {
                this.data.pre_state_id = newValue;
            }
        },
        // Watch for changes in Present District
        'data.pre_district_id'(newValue) {
            if (this.data.block) {
                this.data.per_district_id = newValue;
            }
        },
        // Watch for changes in Permanent District
        'data.per_district_id'(newValue) {
            if (this.data.block) {
                this.data.pre_district_id = newValue;
            }
        },
        // Watch for changes in Present Upazilla
        'data.pre_upazilla_id'(newValue) {
            if (this.data.block) {
                this.data.per_upazilla_id = newValue;
            }
        },
        // Watch for changes in Permanent Upazilla
        'data.per_upazilla_id'(newValue) {
            if (this.data.block) {
                this.data.pre_upazilla_id = newValue;
            }
        },
        'data.pre_thana_id'(newValue) {
            if (this.data.block) {
                this.data.per_thana_id = newValue;
            }
        },
        'data.per_thana_id'(newValue) {
            if (this.data.block) {
                this.data.pre_thana_id = newValue;
            }
        },
        // Update is_primary in the data when the selected index changes
        primaryIndex(newIndex) {
            this.data.beneficiary_occupations.forEach((occupation, index) => {
                occupation.is_primary = index === newIndex ? 1 : 0;
            });
        },
    },
    methods: {
        submit: function (e) {
            this.$validate().then((res) => {
                ...
                for (let index = 0; index < this.data.beneficiary_educations.length; index++) {
                    const education = this.data.beneficiary_educations[index];
                    if (this.isFieldRequired(index)) {
                        errorCount++;
                    }
                    if (education.exam_id) {
                        if (!education.board) {
                            education.boardError = true;
                            errorCount++;
                        } else {
                            education.boardError = false;
                        }
                        if (!education.institute) {
                            education.instituteError = true;
                            errorCount++;
                        } else {
                            education.instituteError = false;
                        }
                        if (!education.result) {
                            education.resultError = true;
                            errorCount++;
                        } else {
                            education.resultError = false;
                        }
                    }
                }


                let hasPrimaryOccupation = false;
                let hasOccupationWithoutPrimary = false;

                for (let index = 0; index < this.data.beneficiary_occupations.length; index++) {
                    const occupation = this.data.beneficiary_occupations[index];

                    if (occupation.occupation_id) {
                        if (occupation.is_primary === 1) {
                            hasPrimaryOccupation = true;
                            break;
                        } else {
                            hasOccupationWithoutPrimary = true;
                        }
                    }
                }

                if (!hasPrimaryOccupation && hasOccupationWithoutPrimary) {
                    this.$toast("You need to select at least one occupation as Primary", "warning");
                    errorCount++;
                }
                for (let index = 0; index < this.data.beneficiary_occupations.length; index++) {
                    const occupations = this.data.beneficiary_occupations[index];
                    if (this.ocupationsFieldRequired(index)) {
                        errorCount++;
                    }
                    if (occupations.occupation_id) {
                        console.log('occupation', occupations.occupation_id);
                        if (!occupations.working_hour) {
                            occupations.workinghourError = true;
                            errorCount++;
                        } else {
                            occupations.workinghourError = false;
                        }
                        if (!occupations.work_location) {
                            occupations.worklocationError = true;
                            errorCount++;
                        } else {
                            occupations.worklocationError = false;
                        }
                        if (!occupations.monthly_income) {
                            occupations.monthlyincomeError = true;
                            errorount++;
                        } else {
                            occupations.monthlyincomeError = false;
                        }
                    }
                }
                for (let index = 0; index < this.data.beneficiary_family_members.length; index++) {
                    const family = this.data.beneficiary_family_members[index];
                    // Check if `relation_id` is required but missing
                    if (this.familyFieldRequired(index)) {
                        errorCount++;
                    }
                    // Validate other fields only if `relation_id` is selected
                    if (family.relation_id) {
                        if (!family.name) {
                            family.nameError = true;
                            errorCount++;
                        } else {
                            family.nameError = false;
                        }
                        if (!family.gender) {
                            family.genderError = true;
                            errorCount++;
                        } else {
                            family.genderError = false;
                        }
                        if (!family.marital_status) {
                            family.maritalstatusError = true;
                            errorount++;
                        } else {
                            family.maritalstatusError = false;
                        }
                    }
                }

                for (let index = 0; index < this.data.beneficiary_diseases.length; index++) {
                    const diseases = this.data.beneficiary_diseases[index];
                    // Check if `diseases_id` is required but missing
                    if (this.diseaseFieldRequired(index)) {
                        errorCount++;
                    }
                    // Validate other fields only if `relation_id` is selected
                    if (diseases.disease_id) {
                        if (!diseases.affected_date) {
                            diseases.affectdateError = true;
                            errorCount++;
                        } else {
                            diseases.affectdateError = false;
                        }
                    }
                }
                // Check errors in Beneficiary Wealths
                for (let index = 0; index < this.data.beneficiary_wealths.length; index++) {
                    const wealth = this.data.beneficiary_wealths[index];
                    // Check if `wealth_id` is required but missing
                    if (this.wealthFieldRequired(index)) {
                        errorCount++;
                    }
                    // Validate other fields only if `wealth_id` is selected
                    if (wealth.wealth_id) {
                        if (!wealth.sourch_of_ownership) {
                            wealth.sourceofownershipError = true;
                            errorCount++;
                        } else {
                            wealth.sourceofownershipError = false;
                        }
                        if (!wealth.qty) {
                            wealth.quantityError = true;
                            errorCount++;
                        } else {
                            wealth.quantityError = false;
                        }
                    }
                }
                ...
                for (let index = 0; index < this.data.benificiary_assets.length; index++) {
                    const asset = this.data.benificiary_assets[index];

                    // Check if `asset_id` is required but missing
                    if (this.assetFieldRequired(index)) {
                        errorCount++;
                    }
                    // Validate other fields only if `asset_id` is selected
                    if (asset.asset_id) {
                        if (!asset.sourch_of_ownership) {
                            asset.sourceofownershipError = true;
                            errorCount++;
                        } else {
                            asset.sourceofownershipError = false;
                        }
                        if (!asset.qty) {
                            asset.quantityError = true;
                            errorCount++;
                        } else {
                            asset.quantityError = false;
                        }
                    }
                }
                ...
                for (let index = 0; index < this.data.beneficiary_liabilites.length; index++) {
                    const liability = this.data.beneficiary_liabilites[index];
                    // Check if `liability_id` is required but missing
                    if (this.liabilitesFieldRequired(index)) {
                        errorCount++;
                    }
                    // Validate other fields only if `liability_id` is selected
                    if (liability.liability_id) {
                        if (!liability.loan_from) {
                            liability.loanfromError = true;
                            errorCount++;
                        } else {
                            liability.loanfromError = false;
                        }
                        if (!liability.amount) {
                            liability.amountError = true;
                            errorCount++;
                        } else {
                            liability.amountError = false;
                        }
                        if (!liability.start_date) {
                            liability.startdateError = true;
                            errorCount++;
                        } else {
                            liability.startdateError = false;
                        }
                        if (!liability.end_date) {
                            liability.enddateError = true;
                            errorCount++;
                        } else {
                            liability.enddateError = false;
                        }
                    }
                }
                ...
                if (res) {
                    ...
                    formData.append("nid_card", this.data.nid_card);
                    formData.append("emergencey_contact", this.data.emergencey_contact);
                    ...
                    formData.append("pre_thana_id", this.data.pre_thana_id);
                    ...
                    formData.append("per_thana_id", this.data.per_thana_id);
                    formData.append("physical_condition", this.data.beneficiary_healths?.physical_condition || "");
                    ...
                    this.data.beneficiary_occupations.forEach((ocupation, index) => {
                        if (ocupation.occupation_id) {
                            ...
                            formData.append(
                                `beneficiary_occupations[${index}][is_primary]`,
                                ocupation.is_primary ? ocupation.is_primary : 0
                            );
        ...
        handlePrimarySelection(selectedIndex) {
            this.data.beneficiary_occupations.forEach((occupation, index) => {
                if (index !== selectedIndex) {
                    occupation.is_primary = 0;
                }
            });
        },
        //present address and permanent address switch
        updatePermanentAddress() {
            if (this.data.block) {
                ...
                this.data.per_thana_id = this.data.pre_thana_id;
            } else {
        ...
        isFieldRequired(index) {
            const education = this.data.beneficiary_educations[index];
            const isOtherFieldsFilled = education.board || education.institute || education.result;

            // If other fields are filled, and exam_id is missing, return true
            return isOtherFieldsFilled && !education.exam_id;
        },

        ocupationsFieldRequired(index) {
            const occupation = this.data.beneficiary_occupations[index];
            const isAnyFieldFilled = occupation.working_hour || occupation.work_location || occupation.monthly_income
                || occupation.occupation_risk || occupation.past_year_income;

            return isAnyFieldFilled && !occupation.occupation_id;
        },


        familyFieldRequired(index) {
            const family = this.data.beneficiary_family_members[index];
            const isAnyFieldFilled = family.name || family.gender || family.marital_status
                || family.family_date_of_birth || family.family_nid || family.occupation_id
                || family.earn || family.yearly_income || family.last_education_info || family.goes_to_school;

            return isAnyFieldFilled && !family.relation_id;
        },

        diseaseFieldRequired(index) {
            const disease = this.data.beneficiary_diseases[index];
            const isAnyFieldFilled = disease.affected_date || disease.recovery_date || disease.is_continue || disease.is_infectious;

            return isAnyFieldFilled && !disease.disease_id;
        },


        wealthFieldRequired(index) {
            const wealth = this.data.beneficiary_wealths[index];
            const isAnyFieldFilled = wealth.sourch_of_ownership || wealth.qty || wealth.description || wealth.ownership_year || wealth.present_value;

            return isAnyFieldFilled && !wealth.wealth_id;
        },

        assetFieldRequired(index) {
            const asset = this.data.benificiary_assets[index];
            const isAnyFieldFilled = asset.sourch_of_ownership || asset.qty || asset.description || asset.ownership_year || asset.present_value;

            return isAnyFieldFilled && !asset.asset_id;
        },

        liabilitesFieldRequired(index) {
            const liability = this.data.beneficiary_liabilites[index];
            const isAnyFieldFilled = liability.loan_from || liability.qty || liability.start_date
                || liability.end_date || liability.mortgage_asset || liability.amount;

            return isAnyFieldFilled && !liability.liability_id;
        },
        //Multiple Education
        addEducation() {
        ...
        getpreUpazilaByDistrict(id) {
            if (id == null) {
                this.data.pre_upazilla_id = null;
                this.preUpazilla = [];
            }
            this.preUpazilla = [];
            this.data.pre_upazilla_id = null;
        ...
        getThanaByUpazila(type, upazila_id) {
            if (!upazila_id) {
                this.data[`${type}_thana_id`] = null;
                this[`${type}Thanas`] = [];
                return;
            }
            axios
                .get("/get-thana", { params: { upazila_id } })
                .then((res) => {
                    this[`${type}Thanas`] = res.data;
                });
        },
        getModuleData() {
    ...
    validators: {
        ...
        "data.pre_thana_id": function (value = null) {
            return Validator.value(value).required("Present Thana is required");
        },
        "data.per_state_id": function (value = null) {
            return Validator.value(value).required("Permananent State is required");
        },
        "data.per_district_id": function (value = null) {
            return Validator.value(value).required("Permananent District is required");
        },
        "data.per_upazilla_id": function (value = null) {
            return Validator.value(value).required("Permananent Upazila is required");
        },
        "data.per_thana_id": function (value = null) {
            return Validator.value(value).required("Permananent Thana is required");
        },
        "data.email": function (value = null) {
            return Validator.value(value)
                .email();
        },
        "data.beneficiary_healths.weight": function (value = null) {
            return Validator.value(value)
                .regex(/^\d+(\.\d+)?$/, "Weight must be a valid number");
        },
        "data.beneficiary_healths.height": function (value = null) {
            return Validator.value(value)
