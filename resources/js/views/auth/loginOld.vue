                    ...
                    <form v-on:submit.prevent="submit" method="post">
                      <div class="input-groups position-relative">
                        <Input
                          ...
                          field="data.email"
                          :req="true"
                          col="12 col-sm-12 col-md-12 col-xxl-12"
                          :tooltipBox="false"
                      ...
                      <div class="input-groups position-relative">
                        <Input
                          class="fw-bold"
                          :type="visibilityFlag ? 'text' : 'password'"
                          title="Password"
                        ...
                        <template v-if="visibilityFlag == false">
                          <i
                            class="far fa-eye position-absolute show-hide"
                        ...
                        <template v-else>
                          <i
                            class="fa fa-eye-slash position-absolute show-hide"
                        ...
                        <a
                          class="mb-3"
                          href="#"
                          @click.prevent="toggleForgetFlag(true)"
                          >Forgot Password ?</a
                        >
                      </div>
